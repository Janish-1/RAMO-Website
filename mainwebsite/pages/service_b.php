        ...
        <section class="services">
            <div class="container" style="margin-top: 50px;">
                ...
                <div class="section-title" data-aos="zoom-out">
                    <h2>Ls Drive - Commercial Project</h2>
                    <p>Explore the features of our general commercial mobile app</p>
                </div>

                <div class="row">
                    <div class="col-lg-6 order-2 order-lg-1" data-aos="fade-up">
                        <!-- Include an image or visual representation of the mobile app -->
                        <img src="../assets/img/ls-drive-mobile.png" class="img-fluid" alt="Ls Drive Mobile App Image">
                    </div>
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
                        <!-- Include detailed information about the mobile app -->
                        <h3>Key Features:</h3>
                        <h5>
                            <ul class="list-unstyled">
                                <li><i class="bx bx-check-double"></i> Feature 1 description</li><br>
                                <li><i class="bx bx-check-double"></i> Feature 2 description</li><br>
                                <li><i class="bx bx-check-double"></i> Feature 3 description</li><br>
                                <li><i class="bx bx-check-double"></i> Feature 4 description</li><br>
                                <!-- Add more features as needed -->
                            </ul>
                        </h5>

                        <h3>Why Choose Ls Drive?</h3>
                        <p>Ls Drive is a versatile commercial app with the following advantages:</p>
                        <h5>
                            <ul class="list-unstyled">
                                <li><i class="bx bx-check-double"></i> Advantage 1 description</li><br>
                                <li><i class="bx bx-check-double"></i> Advantage 2 description</li><br>
                                <li><i class="bx bx-check-double"></i> Advantage 3 description</li><br>
                                <li><i class="bx bx-check-double"></i> Advantage 4 description</li><br>
                        ...
                        <div class="mt-4">
                            <a href="../pages/serviceform.php" class="btn btn-primary">Get Ls Drive for Your
                                Business!</a>
                        </div>
                    </div>
                </div>
