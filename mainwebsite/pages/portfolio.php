            ...
            <div class="container" style="margin-top:50px">
                ...
                <div class="row portfolio-container" data-aos="fade-up">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app filter-web">
                        <div class="portfolio-img"><img src="../assets/img/portfolio/pujan-path.png" class="img-fluid"
                                alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-img"><img src="../assets/img/portfolio/sportshub.png" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>Sports Hub</h4>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-img"><img src="../assets/img/portfolio/graphic1.jpg" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>Diamond</h4>
                            <p>Diamond Waffers </p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-img"><img src="../assets/img/portfolio/graphic2.jpg" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>Modware</h4>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-img"><img src="../assets/img/portfolio/graphic3.jpg" class="img-fluid"
                                alt=""></div>
                        <div class="portfolio-info">
                            <h4>Skill India</h4>
