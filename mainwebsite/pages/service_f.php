        ...
        <section class="services">
            <div class="container" style="margin-top: 50px;">
                ...
                <div class="section-title" data-aos="zoom-out">
                    ...
                    <p>Boost your online presence and engage your audience with our comprehensive digital marketing
                        solutions</p>
                </div>

                <div class="row">
                    <div class="col-lg-6 order-2 order-lg-1" data-aos="fade-up">
                        <!-- Include an image or visual representation of digital marketing -->
                        <img src="../assets/img/digital-marketing.png" class="img-fluid" alt="Digital Marketing Image">
                    </div>
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
                        <!-- Include detailed information about digital marketing -->
                        <h3>What We Offer:</h3>
                        <p>At RAMO Pvt Ltd, our digital marketing strategies are designed to elevate your brand
                            and drive
                            meaningful results. We leverage the power of online channels to enhance your visibility and
                            engagement.</p>

                        <h3>Key Services:</h3>
                        <h5>
                            <ul class="list-unstyled">
                                <li><i class="bx bx-check-double"></i> Search Engine Optimization (SEO)</li><br>
                                <li><i class="bx bx-check-double"></i> Social Media Marketing (SMM)</li><br>
                                <li><i class="bx bx-check-double"></i> Pay-Per-Click (PPC) Advertising</li><br>
                                <li><i class="bx bx-check-double"></i> Content Marketing</li><br>
                                <li><i class="bx bx-check-double"></i> Email Marketing</li><br>
                                <li><i class="bx bx-check-double"></i> Analytics and Reporting</li><br>
                        ...
                        <h5>
                            <ul class="list-unstyled">
                                <li><i class="bx bx-check-double"></i> Targeted and data-driven strategies</li><br>
                                <li><i class="bx bx-check-double"></i> Increased online visibility and brand awareness
                                </li><br>
                                <li><i class="bx bx-check-double"></i> ROI-focused campaigns</li><br>
                                <li><i class="bx bx-check-double"></i> Transparent reporting and analytics</li><br>
                        ...
                        <div class="mt-4">
                            <a href="../pages/serviceform.php" class="btn btn-primary">Boost Your Digital Presence
                                Now!</a>
                        </div>
                    </div>
                </div>
